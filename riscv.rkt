...
;;  #:spec (λ (res)
;;           (and (eq? (list-ref res 1) (bvadd val-rvpc (bv 4 XLEN)))
;;                (eq? (list-ref res 4) (bvsub val-immi val-src2))))
;;  #:assumptions #f)
...
;;  #:solver (boolector)
;;  #:spec (λ (res)
;;           (and (eq? (list-ref res 1) (bvadd val-src2 val-immi))
...
;;  #:spec (λ (res)
;;           (and (eq? (list-ref res 1) (bvadd val-rvpc (bv 4 XLEN)))
;;                (eq? (list-ref res 4) (if (bvslt val-src1 val-src2) (bv 1 XLEN) (bv 0 XLEN)))))
;;  #:assumptions #f)
...
;;  #:spec (λ (res)
;;           (and (eq? (list-ref res 1) (bvadd val-rvpc (bv 4 XLEN)))
;;                (eq? (list-ref res 4) (if (bvult val-src1 val-src2) (bv 1 XLEN) (bv 0 XLEN)))))
;;  #:assumptions #f)
...
;;  #:spec (λ (res)
;;           (and (eq? (list-ref res 1) (bvadd val-rvpc (bv 4 XLEN)))
;;                (eq? (list-ref res 4) (bvshl val-src2 val-src1))))
;;  #:assumptions (λ (mem) ;; restrict shift amount for sll/slli/srl/srli
;;                  (assume
;;                   (bvult (list-ref mem 2) (bv XLEN XLEN)))))
...
;;  #:spec (λ (res)
;;           (and (eq? (list-ref res 1) (bvadd val-rvpc (bv 4 XLEN)))
;;                (eq? (list-ref res 4) (bvlshr val-src1 val-immi))))
;;  #:assumptions (λ (mem) ;; restrict shift amount for sll/slli/srl/srli
;;                  (assume
...
;;  #:spec (λ (res)
;;           (and (eq? (list-ref res 1) (bvadd val-rvpc (bv 4 XLEN)))
;;                (eq? (list-ref res 4) (bvashr val-src1 val-immi))))
;;  #:assumptions (λ (mem) ;; restrict shift amount for sll/slli/srl/srli
;;                  (assume
;;                   (bvult (list-ref mem 8) (bv (- XLEN 1) XLEN)))))
